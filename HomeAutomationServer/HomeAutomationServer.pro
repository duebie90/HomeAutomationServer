...
#else:win64:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../HomeAutomation-Services/debug/ -lHomeAutomation-Services
#else:unix: LIBS += -L$$OUT_PWD/../HomeAutomation-Services/ -lHomeAutomation-Services

LIBS += -L$$OUT_PWD/../HomeAutomation-Services/debug/ -lHomeAutomation-Services
...
LIBS += -L$$OUT_PWD/../HomeAutomation-Devices/debug/ -lHomeAutomation-Devices
...
LIBS += -L$$OUT_PWD/../HomeAutomation-Network/debug/ -lHomeAutomation-Network

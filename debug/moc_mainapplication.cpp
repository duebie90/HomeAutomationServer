...
QT_MOC_LITERAL(1, 16, 14), // "signalFinished"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 8), // "slotQuit"
QT_MOC_LITERAL(4, 41, 3), // "run"
QT_MOC_LITERAL(5, 45, 15) // "slotAboutToQuit"

    },
    "MainApplication\0signalFinished\0\0"
    "slotQuit\0run\0slotAboutToQuit"
};
...
void MainApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->run(); break;
        case 3: _t->slotAboutToQuit(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainApplication::signalFinished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MainApplication::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MainApplication.data,
...
// SIGNAL 0
void MainApplication::signalFinished()
{
